...
//     <section
//       id="project"
//       className="bg-[#1C1F35] text-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 2xl:px-40"
...
//             {/* Hover content */}
//             <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition duration-500 text-center">
//               <h3 className="text-xl font-semibold mb-4">{item.title}</h3>
//               <p className="text-lg font-medium mb-4 w-[500px]">{item.desc}</p>
//               <a
//                 href={item.link}
//                 target="_blank"
